...
[FerIOX](https://kick.com/feriox) Kick App es una aplicación completa que permite la integración segura con la API de KICK mediante OAuth 2.1 con PKCE (Proof Key for Code Exchange). El proyecto implementa las mejores prácticas de seguridad y arquitectura moderna para aplicaciones full-stack.

<a href="#"><img src="https://img.shields.io/badge/status-en%20desarrollo-orange?style=flat&logo=github" alt="Estado: En desarrollo"></a> <a href="https://github.com/Defer1189/feriox-kickapp"><img src="https://img.shields.io/github/repo-size/Defer1189/feriox-kickapp?style=flat&logo=github" alt="Tamaño del repositorio"></a> <a href="https://github.com/Defer1189/feriox-kickapp"><img src="https://img.shields.io/github/last-commit/Defer1189/feriox-kickapp?style=flat&logo=git" alt="Último commit"></a>
...
- **Node.js** >= 18.0.0
- **npm** o **yarn**
- Cuenta en [KICK](https://kick.com) con 2FA habilitado
- Aplicación que cumpla con los [Terminos de Servicio](https://dev.kick.com/terms-of-service) de [KICK Dev](https://dev.kick.com)
...
1. Inicia sesión en tu cuenta de KICK
2. Activa 2FA en tu cuenta (obligatorio)
3. Ve a **Settings** → **Developer**
4. Crea una nueva aplicación utilizando el formulario para crear una aplicación
5. Configura:
    - **Name**: FerIOX Kick App
    - **Description**: Aplicación de ejemplo para integración con KICK API usando OAuth 2.1
    - **OAuth Redirect URIs**: `http://localhost:3000/api/auth/callback`
    - **Scopes**: Selecciona los scopes necesarios (por ejemplo, `user:read`, `user:email`)
6. Guarda la aplicación y obtén las credenciales:
    - `Client ID`
    - `Client Secret`
...
Este proyecto está bajo la Licencia MIT - ver el archivo [LICENSE](https://github.com/Defer1189/feriox-kickapp/tree/main?tab=MIT-1-ov-file) para más detalles.

---

## 👨‍💻 Autor

**[FerIOX](https://kick.com/feriox)**
...
**Desarrollado con ❤️ por [FerIOX](https://kick.com/feriox)**
